...
#invite:hover, input[type="submit"]:hover{   
    background-color: whitesmoke;
}
h2{
    border-bottom-width: thin;
    border-bottom: #D9304F;
    border-bottom-style: solid;
}
...
.btn-primary:active {
    ...
    border-color:#D9304F;
    color: whitesmoke;
    box-shadow: 0 0 0 .2rem rgba(255, 38, 74, 0.5);
}
